    ...
    <>
      <div className="mb-8 flex items-center justify-between">
        ...
        <Button variant="brand" asChild>
          <Link href="/admin/brands/new"><Plus className="size-4" /> Nueva marca</Link>
        </Button>
      </div>
            ...
            <TableBody>
              {brands.map((b) => (
                <TableRow key={b.id}>
                  ...
                  <TableCell className="tabular-nums font-medium">{b._count.products}</TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <BrandActions id={b.id} isActive={b.isActive} />
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
